    ...
    namespace Defra.CustomerMaster.Identity.Api.Dynamics
    {
        ...
        public class Authentication
        {
            ...
            public string Authority
            {
                ...
                {
                if (_authority == null)
                    // "https://login.windows.net/6f504113-6b64-43f2-ade9-242e05780007/oauth2/authorize";
            ...
            public AuthenticationResult AcquireToken()
            {
                ...
                //var clientCredential = new ClientCredential(_config.ClientId, "XJ2QtsVvLKMtBwvoiO/xtuJow9XehQfUZLnpOpSE9Do=");
                //return _context.AcquireToken(_config.ServiceUrl, clientCredential);
